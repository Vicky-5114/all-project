...
def main(args: ArgumentParser):
    ...
    new_lyrics_list = [l.strip() for l in lyrics_list]
    new_lyrics_list = [l for l in new_lyrics_list if l != ""]
    # Or
    # new_lyrics_list = [l.strip() for l in lyrics_list if l.strip()]
    max_length = max(len(l) for l in new_lyrics_list)
    ...
    centered_lyrics = [l.center(max_length) for l in new_lyrics_list]
    ...
    #     print(l)
    [print(l) for l in centered_lyrics]
